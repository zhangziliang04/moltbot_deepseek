...
// DeepSeek V3 context window is 64k
...
export const DEEPSEEK_DEFAULT_COST = {
  input: 0.14, // $0.14 / 1M input
  output: 0.28, // $0.28 / 1M output
  cacheRead: 0.014, // 0.014 / 1M cache read (guess based on 1/10th) - actually verify if possible but low is safe defaults
  cacheWrite: 0.14,
};
